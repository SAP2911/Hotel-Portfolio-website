...
! function(e, t) {
    ...
    function L(e, o) {
        if ("viewport" === o) e = k({
            ...
            var a = s(e);
            e = r(a), o = n(a), (a = p(s(a), e)).height = Math.max(a.height, e.innerHeight), a.width = Math.max(a.width, e.innerWidth), a.x = -o.scrollLeft, a.y = -o.scrollTop, e = k(a)
        }
        return e
    }
    ...
    function H(e, r) {
        ...
        var p = n.altBoundary,
            c = void 0 !== p && p;
        n = W("number" != typeof(n = void 0 === (n = n.padding) ? 0 : n) ? n : B(n, q));
        ...
        p = e.rects.popper, a = P(o(c = e.elements[c ? "popper" === i ? "reference" : "popper" : i]) ? c : s(e.elements.popper), a, f), c = O({
            ...
            strategy: "absolute",
            placement: r
        }), p = k(Object.assign({}, p, {}, c)), f = "popper" === i ? p : f;
        var d = {
        ...
        V = [{
            ...
            fn: function(e) {
                ...
                if (e = e.name, !t.modifiersData[e]._skip) {
                    ...
                    for (var u = p[0], d = 0; d < p.length; d++) {
                        ...
                        if (h = v ? h ? "right" : "left" : h ? "bottom" : "top", n[g] > r[g] && (h = j(h)), g = j(h), (m = [0 >= y[m], 0 >= y[h], 0 >= y[g]]).every((function(e) {
                                return e
                            }))) {
                            u = l, f = !1;
                            break
                    ...
                    if (f)
                        for (n = function(e) {
                                var t = p.find((function(t) {
                                    if (t = c.get(t)) return t.slice(0, e).every((function(e) {
                                        return e
                                    }))
                                }));
                                if (t) return u = t, "break"
                            }, r = s ? 3 : 1; 0 < r && "break" !== n(r); r--);
            ...
            fn: function(e) {
                ...
                if (s = {
                    ...
                    v = D[v], g = D[g], m = Math.max(0, Math.min(l[y], m[y])), D = t.modifiersData.offset ? t.modifiersData.offset[t.placement][u] : 0, j = d[u] + (p ? l[y] / 2 - M - m - v - h : j - m - v - h) - D, p = d[u] + (p ? -l[y] / 2 + M + m + g + h : f + m + g + h) - D, i = Math.max(i ? Math.min(x, j) : x, Math.min(o, i ? Math.max(O, p) : O)), d[u] = i, s[u] = i - o
                }
            ...
            fn: function(e) {
                ...
                r = R(i, r), n = R(a, n, o), o = T(r), a = T(n), t.modifiersData[e] = {
