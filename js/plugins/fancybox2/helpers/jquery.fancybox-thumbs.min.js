    ...
    t.fancybox.helpers.thumbs = {
        ...
        init: function(i, h) {
            var e, s = this,
                ...
                a = i.source;
            e = "";
            for (var l = 0; l < h.group.length; l++) e += '<li><a style="width:' + o + "px;height:" + n + 'px;" href="javascript:jQuery.fancybox.jumpto(' + l + ');"></a></li>';
            this.wrap = t('<div id="fancybox-thumbs"></div>').addClass(i.position).appendTo("body"), this.list = t("<ul>" + e + "</ul>").appendTo(this.wrap), t.each(h.group, function(i) {
                ...
                e && t("<img />").load(function() {
                    var h, e, a, l = this.width,
                        r = this.height;
                    s.list && l && r && (h = l / o, e = r / n, a = s.list.children().eq(i).find("a"), h >= 1 && e >= 1 && (h > e ? (l = Math.floor(l / e), r = n) : (l = o, r = Math.floor(r / h))), t(this).css({
                        width: l,
                        height: r,
                        top: Math.floor(n / 2 - r / 2),
                        left: Math.floor(o / 2 - l / 2)
                    }), a.width(o).height(n), t(this).hide().appendTo(a).fadeIn(300))
                }).attr("src", e)
